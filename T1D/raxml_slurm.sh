...
raxml-ng --search --msa /bulk/sycuro_bulk/daniel/diabetes/UC_UT_collaboration/16S_data/16S_after_fixing_and_discussion/good_files_to_use/MAFFT_consortia/rm_dupt1d_db2_withDups_S_S2_species_aligned.fasta --model GTR+G --prefix S2_ML --seed 100 --threads 4

raxml-ng --search --msa /bulk/sycuro_bulk/daniel/diabetes/UC_UT_collaboration/16S_data/16S_after_fixing_and_discussion/good_files_to_use/MAFFT_consortia/rm_dupt1d_db2_withDups_S_S5_species_aligned.fasta --model GTR+G --prefix S5_ML --seed 100 --threads 4
